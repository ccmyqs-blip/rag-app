...
def load_system_prompts():
    ...
    try:
        ...
        logger.error(f"[load_system_prompts]解析系统提示词出错")
        raise e
...
def load_rag_prompts():
    ...
    try:
        ...
        logger.error(f"[load_rag_prompts]解析RAG提示词出错")
        raise e

def load_report_prompts():
    try :
        report_prompts_path = get_abs_path(prompts_conf["report_prompt_paths"])
    except KeyError as e:
    ...
    try:
        ...
        logger.error(f"[load_system_prompts]解析报告生成提示词出错")
        raise e
